...
function App(props) {
  ...
  const balance = useContractReader(readContracts, "YogiBooNFT", "balanceOf", [address]);
  console.log("🤗 balance:", balance);

  // 📟 Listen for broadcast events
  const transferEvents = useEventListener(readContracts, "YogiBooNFT", "Transfer", localProvider, 1);
    ...
    const updateYourCollectibles = async () => {
      ...
      for (let tokenIndex = 0; tokenIndex < balance; tokenIndex++) {
        try {
          ...
          const tokenId = await readContracts.YogiBooNFT.tokenOfOwnerByIndex(address, tokenIndex);
          console.log("tokenId", tokenId);
          const tokenURI = await readContracts.YogiBooNFT.tokenURI(tokenId);
                      ...
                      <List.Item key={id + "_" + item.uri + "_" + item.owner}>
                        ...
                        <div>
                          ...
                          <Button
                            onClick={() => {
                              console.log("writeContracts", writeContracts);
                              tx(writeContracts.YogiBooNFT.transferFrom(address, transferToAddresses[id], id));
                            }}
                          >
                            Transfer
                          </Button>
